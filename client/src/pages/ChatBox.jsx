  ...
  return (
    user && (
      <div className="flex flex-col h-screen">
        <div
          className="flex items-center gap-2 p-2 md:px-10 xl:pl-24
    bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-gray-300 "
        ...
        <div className="p-5 md:px-10 h-full overflow-y-scroll">
          <div className="space-y-4 max-w-pxl mx-auto">
            {messages
            ...
            <label htmlFor="image">
              {image ? (
                <img
                  ...
                  className="h-8  roundedf"
                  alt=""
                />
              ) : (
                <ImageIcon className="size-7 text-grey-400 cursor-pointer" />
              )}
              <input
                type="file"
                id="image"
